...
import { mindScrollForm } from '/js/mindScrollForm.js';
...
const story2 = laptopPopScene;

const stories = [story1,story2];

const element1 = document.getElementById('title_THREEBG');
const element2 = document.getElementById('laptopPopTHREE');
...
document.addEventListener('DOMContentLoaded', () => { //wait for dom to load
    ...
    const mindScroll = new mindScrollForm(elements,stories);
});